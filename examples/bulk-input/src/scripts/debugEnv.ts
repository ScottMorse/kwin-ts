...
print("KWin", KWin);
print("KWin.PlacementArea", KWin.PlacementArea);
print("KWin.MovementArea", KWin.MovementArea);
print("KWin.MaximizeArea", KWin.MaximizeArea);
print("KWin.MaximizeFullArea", KWin.MaximizeFullArea);
print("KWin.FullScreenArea", KWin.FullScreenArea);
print("KWin.WorkArea", KWin.WorkArea);
print("KWin.FullArea", KWin.FullArea);
print("KWin.ScreenArea", KWin.ScreenArea);

print("KWin.ElectricTop", KWin.ElectricTop);
print("KWin.ElectricTop", KWin.ElectricTop);
print("KWin.ElectricTopRight", KWin.ElectricTopRight);
print("KWin.ElectricRight", KWin.ElectricRight);
print("KWin.ElectricBottomRight", KWin.ElectricBottomRight);
print("KWin.ElectricBottom", KWin.ElectricBottom);
print("KWin.ElectricBottomLeft", KWin.ElectricBottomLeft);
print("KWin.ElectricLeft", KWin.ElectricLeft);
print("KWin.ElectricTopLeft", KWin.ElectricTopLeft);
print("KWin.ELECTRIC_COUNT", KWin.ELECTRIC_COUNT);
print("KWin.ElectricNone", KWin.ElectricNone);
