import type { QPoint, QRect, QSize } from "../qml";
import type { Desktop } from "./desktop";
import type { Output } from "./output";
import type { TileManager } from "./tileManager";
import type { KWindow } from "./window";

type ClientAreaOption = number;

export interface WorkspaceSignal<Data> {
  connect(callback: (data: Data) => void): void;
}
...
export interface Workspace {
  ...
  windowAdded: WorkspaceSignal<KWindow>;
  windowRemoved: WorkspaceSignal<KWindow>;
  windowActivated: WorkspaceSignal<KWindow>;
  desktopsChanged: WorkspaceSignal<void>;
  desktopLayoutChanged: WorkspaceSignal<void>;
  screensChanged: WorkspaceSignal<void>;
  currentActivityChanged: WorkspaceSignal<string>;
  activitiesChanged: WorkspaceSignal<string>;
  activityAdded: WorkspaceSignal<string>;
  activityRemoved: WorkspaceSignal<string>;
  virtualScreenSizeChanged: WorkspaceSignal<void>;
  virtualScreenGeometryChanged: WorkspaceSignal<void>;
  currentDesktopChanged: WorkspaceSignal<Desktop>;
  cursorPosChanged: WorkspaceSignal<void>;
}
